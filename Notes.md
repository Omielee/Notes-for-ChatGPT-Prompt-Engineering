...
### Setup
```
# Install the necessary libraries for the first time
pip install openai
pip install python-dotenv

# Load the API key and relevant Python libaries
# This part of code is different from the video
import os
import openai
openai.api_key  = "sk-???" # change ??? to your openai api key
```
### Help function
```
# Define a function to get response as an example
...
print(response)
```
### Example 3: Check whether conditions are satisfied
```
text_1 = f"""
...
print(response)
```
### Example 5: Specify the steps required to complete a task
```
text = f"""
...
print(response)
```
### Example 6: Instruct the model to work out its own solution before rushing to a conclusion
```
prompt = f"""
